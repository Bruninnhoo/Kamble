...
export const metadata: Metadata = {
  title: 'Entrar',
  description: 'Acesse sua conta no Kamble e continue aprendendo inglês.',
}
        ...
        <div className="w-full max-w-md">
          ...
          <form id="login-form" className="space-y-5">
            ...
            <button
              id="login-submit-btn"
              type="submit"
              className="w-full bg-sky-500 hover:bg-sky-400 text-white font-semibold py-3.5 rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] mt-2"
            >
              Entrar
            </button>
          </form>
